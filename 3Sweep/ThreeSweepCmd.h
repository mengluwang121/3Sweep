...
public: 
	...
	void drawInitialCube(float length, float width, vec3 origin, vec3 ax, vec3 rotation, MString name);
	...
	void ThreeSweepCmd::drawSquare(vec3 origin, vec3 normal, float length, float width, MString squareName);
